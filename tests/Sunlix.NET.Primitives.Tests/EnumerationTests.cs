namespace Sunlix.NET.Primitives.Tests
{
    public class EnumerationTests
    {
        ...
        {
            var status = Enumeration<OrderStatus>.FromValue(2);
            var status2 = Enumeration<OrderStatus>.FromName("Pending");
            int c = Enumeration<OrderStatus>.Count;
        ...
        /*[Fact]
        public void Enumeration_should_retrieve_by_name()
        {
        ...
        {
            var statusesNew = new OrderStatus(4, "New");
            var statusPending = Enumeration.GetByValue<OrderStatus>(1);
            var statusShipped = Enumeration.GetByValue<OrderStatus>(2);

            var statuses = Enumeration.GetAll<OrderStatus>().ToList();
        ...
        /*private class InvalidOrderStatus : OrderStatus
        {
            public static readonly OrderStatus Pending2 = new(4, nameof(Pending2));

            public InvalidOrderStatus(int value, string displayName) : base(value, displayName) { }
        }*/

        /*private class InvalidNameOrderStatus : Enumeration<OrderStatus>
        {
            ...
            public static readonly OrderStatus InvalidNamePending = new(4, nameof(Pending));

            public InvalidNameOrderStatus(int value, string displayName) : base(value, displayName) { }
        }*/
